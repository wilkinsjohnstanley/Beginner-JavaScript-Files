...
//    console.log(chars[i]); //for the entire object
//     console.log(chars[i].name); //to target a specific property
//    console.log(chars[i]['voice']); //to target a specific property
